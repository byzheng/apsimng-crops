...
The table below summarizes the performance of APSIM NG for `r ifelse(cultivar == "All", "all cultivars", paste0("cultivar ", cultivar))` across all experiments.


```{r tbl-performance-summary}
tbl_cap <- ifelse(cultivar == "All", "Performance summary for all cultivars", 
    sprintf("Performance summary for cultivar `%s`", cultivar))
obs_sim_cultivar |> 
