...
The following aliases are also available for this cultivar:

```{r tbl-cultivar_aliases}
cultivar_info |> 
    dplyr::distinct(name) |>
    knitr::kable(caption = sprintf("Aliases for cultivar `%s`", cultivar), col.names = NULL)
